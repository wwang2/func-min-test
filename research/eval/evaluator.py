...
import traceback
import signal
# Standalone shim — replaces openevolve.evaluation_result dependency
class EvaluationResult:
    def __init__(self, metrics=None, combined_score=0.0, **kwargs):
        self.metrics = metrics or {}
        self.combined_score = combined_score
        for k, v in kwargs.items():
            setattr(self, k, v)
    def __repr__(self):
        return f"EvaluationResult(combined_score={self.combined_score}, metrics={self.metrics})"
